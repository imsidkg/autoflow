...
import { useNodeId, Handle, Position, type NodeProps } from "@xyflow/react";
...
export const PlaceholderNode = forwardRef<HTMLDivElement, PlaceholderNodeProps>(
  ({ children, onClick }, ref) => {
    ...
    return (
      <BaseNode
        ref={ref}
        className="w-auto h-auto border-dashed border-gray-400 bg-card p-4 text-center cursor-pointer hover:border-gray-500 hover:bg-gray-50 text-gray-400 shadow-none"
        onClick={onClick}
      >
        {children}
        <Handle
